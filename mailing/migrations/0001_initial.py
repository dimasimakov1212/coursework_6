    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('log_status', models.BooleanField(choices=[(True, 'отправлено'), (False, 'не отправлено')], default=False, verbose_name='Статус')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mailing_period', models.CharField(choices=[('hourly', 'ежечасно'), ('daily', 'ежедневно'), ('weekly', 'еженедельно'), ('monthly', 'ежемесячно')], max_length=20, verbose_name='периодичность')),
                ('mailing_status', models.CharField(choices=[('created', 'создано'), ('sent', 'рассылается'), ('stopped', 'остановлено')], max_length=20, verbose_name='статус')),
                ('mailing_log', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mailing.log', verbose_name='лог')),
                ('mailing_message', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mailing.message', verbose_name='сообщение')),
                ('mailing_owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='владелец')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client_owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='владелец')),
            ],
            options={
                'verbose_name': 'Клиент',
